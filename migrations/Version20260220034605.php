 ...
 */
final class Version20260220034605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(30) NOT NULL, description LONGTEXT NOT NULL, duration INT NOT NULL, validation_score DOUBLE PRECISION NOT NULL, content VARCHAR(255) NOT NULL, material VARCHAR(255) DEFAULT NULL, sections_to_review JSON DEFAULT NULL, creator_id INT NOT NULL, prerequisite_quiz_id INT DEFAULT NULL, INDEX IDX_169E6FB961220EA6 (creator_id), INDEX IDX_169E6FB9618C39EB (prerequisite_quiz_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE quiz (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(30) NOT NULL, passing_score DOUBLE PRECISION NOT NULL, max_attempts INT NOT NULL, questions_per_attempt INT DEFAULT NULL, course_id INT NOT NULL, chapter_id INT DEFAULT NULL, supervisor_id INT NOT NULL, INDEX IDX_A412FA92591CC992 (course_id), UNIQUE INDEX UNIQ_A412FA92579F4768 (chapter_id), INDEX IDX_A412FA9219E9AC5F (supervisor_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(30) NOT NULL, prenom VARCHAR(30) DEFAULT NULL, date_naissance DATE DEFAULT NULL, email VARCHAR(180) NOT NULL, ban TINYINT DEFAULT 0 NOT NULL, photo VARCHAR(255) DEFAULT NULL, passwd VARCHAR(255) NOT NULL, date_inscrit DATETIME NOT NULL, is_active TINYINT DEFAULT 1 NOT NULL, report_nbr INT DEFAULT 0 NOT NULL, previous_role VARCHAR(30) DEFAULT NULL, type VARCHAR(255) NOT NULL, experience LONGTEXT DEFAULT NULL, education VARCHAR(255) DEFAULT NULL, skills LONGTEXT DEFAULT NULL, score_generale INT DEFAULT NULL, domaine VARCHAR(50) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
