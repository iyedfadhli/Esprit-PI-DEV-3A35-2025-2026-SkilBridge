 ...
 */
final class Version20260208173522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE course DROP sections_to_review, DROP prerequisite_quiz_id, DROP material');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE course ADD sections_to_review JSON DEFAULT NULL, ADD prerequisite_quiz_id INT DEFAULT NULL, ADD material VARCHAR(255) DEFAULT NULL');
