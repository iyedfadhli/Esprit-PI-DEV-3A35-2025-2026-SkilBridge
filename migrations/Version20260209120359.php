 ...
 */
final class Version20260209120359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(30) NOT NULL, description LONGTEXT NOT NULL, duration INT NOT NULL, validation_score DOUBLE PRECISION NOT NULL, content VARCHAR(255) NOT NULL, creator_id INT NOT NULL, INDEX IDX_169E6FB961220EA6 (creator_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
